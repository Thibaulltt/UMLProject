...
On stock en fait des pointeurs vers un objetCarte afin de gérer les problèmes d' "object slicing" liés au C++, afin de pouvoir utiliser les fonction overridden des classes filles.
*/
class carte
{
	//! Taille de la carte.
	...
	//! Tableau où chaque case est un vecteur d'objetCarte.
